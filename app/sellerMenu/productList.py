...
class ProductList(customtkinter.CTkFrame):
    TABLE = "PRODUCT"
    ...
    def __init__(self, parent, controller):
        ...
        self.entry6 = customtkinter.CTkEntry(self, width=600, font=('Segoe Ui', 14), textvariable = self.placeHolder6)
        self.entry7 = customtkinter.CTkEntry(self, width=600, font=('Segoe Ui', 14), textvariable = self.placeHolder7)
        ...
        self.tree.column(self.ATTRIBUTE1, anchor=W, width=100)
        self.tree.column(self.ATTRIBUTE2, anchor=W, width=210)
        self.tree.column(self.ATTRIBUTE3, anchor=W, width=210)
        self.tree.column(self.ATTRIBUTE4, anchor=W, width=250)
        self.tree.column(self.ATTRIBUTE5, anchor=W, width=170)
        self.tree.column(self.ATTRIBUTE6, anchor=W, width=150)
        self.tree.column(self.ATTRIBUTE7, anchor=W, width=170)
    ...
    def select(self):
        try:
            ...
            attribute7 = str(selectedItem.split( ).pop())
            ...
            self.controller.setPlaceHolder(self, attribute6, 6)
            self.controller.setPlaceHolder(self, attribute7, 7)
        except:
