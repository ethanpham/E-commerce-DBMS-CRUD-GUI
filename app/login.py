...
class Login(customtkinter.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.info = customtkinter.CTkLabel(self.loginFrame, text="Login", font=('Segoe Ui Bold', 18), text_color="#1F6AA5")
        self.info.grid(row=0, column=0, columnspan=4, sticky="nwe", padx=360, pady=(20, 30))

        self.label1 = customtkinter.CTkLabel(self.loginFrame, text = "Username", font=('Segoe Ui Bold', 14), text_color="#1F6AA5")
        self.label2 = customtkinter.CTkLabel(self.loginFrame, text = "Password", font=('Segoe Ui Bold', 14), text_color="#1F6AA5")
        
        self.label1.grid(row=1, column=0, padx=(20,0), pady=5)
        self.label2.grid(row=2, column=0, padx=(20,0), pady=5)

        self.entry1 = customtkinter.CTkEntry(self.loginFrame, width=480, height=40, font=('Segoe Ui', 14), textvariable = self.placeHolder1)
        self.entry2 = customtkinter.CTkEntry(self.loginFrame, width=480, height=40, font=('Segoe Ui', 14), textvariable = self.placeHolder2)
