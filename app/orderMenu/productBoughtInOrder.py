...
class ProductBoughtInOrder(customtkinter.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.tree.column(self.ATTRIBUTE4, anchor=W, width=300)
        self.tree.column(self.ATTRIBUTE5, anchor=W, width=300)
        self.tree.column(self.ATTRIBUTE6, anchor=W, width=300)
        self.tree.column(self.ATTRIBUTE7, anchor=W, width=270)
