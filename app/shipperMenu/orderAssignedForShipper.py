...
class OrderAssignedForShipper(customtkinter.CTkFrame):
    TABLE = "SHIPPER_ORDER"
    NUMBER_OF_ATTRIBUTE = 5
    ATTRIBUTE1 = "ShipperID"
    ATTRIBUTE2 = "OrderID"
    ATTRIBUTE3 = "Address"
    ATTRIBUTE4 = "StartingDate"
    ATTRIBUTE5 = "EstimatedArrivalDate"
    ATTRIBUTE6 = ""
    ATTRIBUTE7 = ""
    ...
    def __init__(self, parent, controller):
        ...
        self.headingLabel = customtkinter.CTkLabel(self, 
                                                   text = "SHIPPER_ORDER TABLE", 
                                                   font=('Segoe Ui Bold', 18),
                                                   text_color="#E5E5E5")
        self.headingLabel.grid(row=1, column=0, columnspan=10, padx=80, pady=(0,25))
        ...
        self.label1.grid(row=3, column=0, padx=(40,0), pady=5)
        self.label2.grid(row=4, column=0, padx=(40,0), pady=5)
        self.label3.grid(row=5, column=0, padx=(40,0), pady=5)
        self.label4.grid(row=6, column=0, padx=(40,0), pady=5)
        self.label5.grid(row=7, column=0, padx=(40,0), pady=5)
        self.label6.grid(row=8, column=0, padx=(40,0), pady=5)
        self.label7.grid(row=9, column=0, padx=(40,0), pady=5)
        ...
        self.entry3 = customtkinter.CTkEntry(self, width=600, font=('Segoe Ui', 14), textvariable = self.placeHolder3)
        self.entry4 = customtkinter.CTkEntry(self, width=600, font=('Segoe Ui', 14), textvariable = self.placeHolder4)
        self.entry5 = customtkinter.CTkEntry(self, width=600, font=('Segoe Ui', 14), textvariable = self.placeHolder5)
        ...
        self.entry1.grid(row=3, column=1, padx=(7,20), pady=0)
        self.entry2.grid(row=4, column=1, padx=(7,20), pady=0)
        self.entry3.grid(row=5, column=1, padx=(7,20), pady=0)
        self.entry4.grid(row=6, column=1, padx=(7,20), pady=0)
        self.entry5.grid(row=7, column=1, padx=(7,20), pady=0)
        self.entry6.grid(row=8, column=1, padx=(7,20), pady=0)
        self.entry7.grid(row=9, column=1, padx=(7,20), pady=0)
    ...
    def select(self):
        try:
            ...
            self.controller.setPlaceHolder(self, attribute4, 4)
            self.controller.setPlaceHolder(self, attribute5, 5)
        except:
