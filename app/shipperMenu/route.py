...
class Route(customtkinter.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.tree.column(self.ATTRIBUTE2, anchor=W, width=180)
        self.tree.column(self.ATTRIBUTE3, anchor=W, width=160)
        self.tree.column(self.ATTRIBUTE4, anchor=W, width=100)
        self.tree.column(self.ATTRIBUTE5, anchor=W, width=100)
        self.tree.column(self.ATTRIBUTE6, anchor=W, width=100)
        self.tree.column(self.ATTRIBUTE7, anchor=W, width=200)
