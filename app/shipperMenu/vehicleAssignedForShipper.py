...
class VehicleAssignedForShipper(customtkinter.CTkFrame):
    TABLE = "SHIPPER_VEHICLE"
    ...
    def __init__(self, parent, controller):
        ...
        self.tree.column(self.ATTRIBUTE3, anchor=W, width=170)
